...
const Toast = () => {
  ...
  return (
    <div className="  fixed top-12 right-8 z-20 bottom-5  h-fit flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400">
      {Icon}
